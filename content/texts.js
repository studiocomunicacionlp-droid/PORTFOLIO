    ...
    items: [
      {
        ...
        features: ["Marcas personales", "Marcas comerciales", "Reels para Instagram & TikTok"],
        price: "Desde $15 USD",
      },
      {
        ...
        features: ["Ecommerce & tiendas online", "Ads para Meta & TikTok", "Reels de producto básicos"],
        price: "Desde $10 USD",
      },
      {
      ...
      },
      {
        ...
        title: "Plan Mensual",
        desc: "El mejor valor: contenido diario de lunes a sábados. Ideal para cuentas que necesitan presencia constante.",
        features: ["9 videos por día", "234 videos al mes", "Lunes a Sábados"],
        price: "Precio especial — consultar",
      },
      {
        ...
        desc: "Edición de videos largos y shorts de YouTube con formato profesional. Precios a coordinar según el proyecto.",
        features: ["Videos largos & Shorts", "Intro, outro y captions", "Precio acordado personalmente"],
      ...
      },
      {
        ...
        desc: "¿Necesitás algo diferente? Armo un pack a medida según tus objetivos, volumen y presupuesto.",
        features: ["Mix de formatos", "Volumen flexible", "Precio adaptado a tu presupuesto"],
        price: "A convenir",
      },
    ],
  },
    ...
    categories: [
      {
        ...
        color: "primary",
        plans: [
          { name: "Edición Individual",  price: "$15 USD",  desc: "1 video editado" },
          { name: "Pack Starter",        price: "$65 USD",  desc: "5 videos  — ahorrás $10" },
          { name: "Pack Growth",         price: "$120 USD", desc: "10 videos — ahorrás $30" },
          { name: "Plan Mensual",        price: "$280 USD", desc: "30 videos — mejor valor" },
        ],
      },
      {
        id: "producto",
        ...
        color: "secondary",
        plans: [
          { name: "Edición Individual", price: "$10 USD",  desc: "1 video editado" },
          { name: "Pack Starter",       price: "$45 USD",  desc: "5 videos  — ahorrás $5" },
          { name: "Pack Growth",        price: "$85 USD",  desc: "10 videos — ahorrás $15" },
          { name: "Plan Mensual",       price: "$225 USD", desc: "30 videos — mejor valor" },
        ],
      },
    ],
    mensual_card: {
    ...
    items: [
      {
        ...
        desc: "Serie de reels de posicionamiento con alto engagement.",
        image: "images/portfolio/project-1.jpg",
        tags: ["Reels Marca", "Instagram"],
        link: "#",
      },
      {
        id: 2, category: "Producto & Ads",
        title: "Tienda Online — Indumentaria",
        desc: "Videos de producto para ads en Meta con 3.2x ROAS.",
      ...
      },
      {
        ...
        title: "Emprendimiento — Gastronomía",
        desc: "Contenido viral para TikTok. +180K views orgánico.",
      ...
      },
      {
        ...
        title: "Marca Comercial — Inmobiliaria",
        desc: "Reels profesionales que generaron +40% de consultas.",
        image: "images/portfolio/project-4.jpg",
        tags: ["Reels Marca", "B2B"],
        link: "#",
      },
      {
        id: 5, category: "YouTube",
        title: "Canal — Finanzas Personales",
        desc: "Edición de videos largos con retención promedio del 68%.",
      ...
      },
      {
        ...
        title: "Ecommerce — Suplementos",
        desc: "Pack mensual de 30 videos de producto para Instagram.",
        image: "images/portfolio/project-6.jpg",
        tags: ["Producto", "Pack Mensual"],
        link: "#",
      },
    ],
  },
